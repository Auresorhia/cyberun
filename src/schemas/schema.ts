export const schema = {
    ...
    definitions: {
      countries: {
        enum: [
          "?Unknown", "Afghanistan", "Albania", "Algeria", "Andorra", 
          "Angola", "Antigua and Barbuda", "Argentina", "Armenia", "Ukraine",
    ...
    properties: {
      user: {
        ...
        type: "object",
        properties: {
          a08: { title: "Name", type: "string", ve: 10 },
          a09: { title: "description of your skills", type: "string", pt: 0, ve: 10 }
        }
      },
      item: {
        title: "My Infos",
        ...
        properties: {
          s01: {
            ...
            uniqueItems: true,
            ve: 10,
            items: { type: "string", enum: ["vendor", "integrator", "parent company", "subcontractor"] }
          },
          p02: {
          ...
          i01: {
            ...
            items: {
              type: "object",
              properties: {
                country: { type: "string", $ref: "#/definitions/countries" },
                percent: { type: "number" }
              }
            }
          }
