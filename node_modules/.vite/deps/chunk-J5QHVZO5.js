...
var JsonFormsStateProvider = ({ children, initState, onChange, middleware }) => {
  var _a, _b, _c;
  ...
  const [core, setCore] = (0, import_react.useState)(() => middlewareRef.current(initState.core, index$1.init(data, schema, uischema, {
    ajv,
    validationMode,
    additionalErrors
  }), coreReducer));
  ...
  const [config, configDispatch] = (0, import_react.useReducer)(configReducer, void 0, () => configReducer(void 0, index$1.setConfig(initState.config)));
  useEffectAfterFirstRender(() => {
    configDispatch(index$1.setConfig(initState.config));
  }, [initState.config]);
  const [i18n, i18nDispatch] = (0, import_react.useReducer)(i18nReducer, void 0, () => {
    var _a2, _b2, _c2;
    return i18nReducer(initState.i18n, index$1.updateI18n((_a2 = initState.i18n) == null ? void 0 : _a2.locale, (_b2 = initState.i18n) == null ? void 0 : _b2.translate, (_c2 = initState.i18n) == null ? void 0 : _c2.translateError));
  });
  (0, import_react.useEffect)(() => {
    var _a2, _b2, _c2;
    i18nDispatch(index$1.updateI18n((_a2 = initState.i18n) == null ? void 0 : _a2.locale, (_b2 = initState.i18n) == null ? void 0 : _b2.translate, (_c2 = initState.i18n) == null ? void 0 : _c2.translateError));
  }, [
...
//# sourceMappingURL=chunk-J5QHVZO5.js.map
